...
describe( 'lofty/kernel/alicn', function(){
    ...
    var configCache = lofty.cache.config,
        id2url = lofty.cache.kernel.id2url.exports;
    ...
    describe( 'config配置', function(){
        ...
        it( 'resolve处理lofty/makeup/sys', function(){
            var a = { id: 'lofty/tests/a' };
            var b = { id: 'lofty/tests/a.css' };
            var c = { id: 'makeup/tests/a' };
            var d = { id: 'makeup/tests/a.css' };
            ...
            expect(c.url.indexOf('fdevlib/js/makeup/tests/a.js')>0).toEqual(true);
            expect(d.url.indexOf('fdevlib/css/makeup/tests/a.css')>0).toEqual(true);
